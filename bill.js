...
function moveBai1() {
  ...
  function movethucdon() {
    window.location.href = "http://127.0.0.1:5500/thucan.html";
  }
...
var plus10 = document.getElementById("cong10");
var input10 = document.getElementById("input10");
var tru10 = document.getElementById("tru10");
var t10=0;  
input10.onchange=function(){
    
    tonghoadon += drink10 * input10.value-drink10*t10;
    t10=input10.value
    document.getElementById("tongtien").innerText = tonghoadon.toLocaleString('vi-VN');
...
//so luong don hang
var soluong=input1.value+input2.value+input3.value+input4.value+input5.value+input6.value+input7.value+input8.value+input9.value+input10.value;
// cho giá tiền của từng thức uống


 var tong = document.getElementById("oke");

function xacnhan(){
    if(tonghoadon == 0) confirm("vui lòng bạn hãy lựa chọn bạn muốn mua bao nhiêu số lượng bởi hiện tại hoá đơn bạn đang có 0 đồng!");
    else
    confirm("Tổng hoá đơn đã mua có tổng giá:"+" " +tonghoadon+" đồng");
}
// cho giá tiền của từng thức uống